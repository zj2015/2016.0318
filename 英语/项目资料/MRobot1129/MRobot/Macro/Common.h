...
//#define PView_BGColor        [UIColor colorWithRed:173.0f/255.0f green:159.0f/255.0f blue:110.0f/255.0f alpha:1.0]   // 底色
#define PView_BGColor        [UIColor colorWithRed:76.0f/255.0f green:76.0f/255.0f blue:78.0f/255.0f alpha:1.0]   // 底色
#define PView_RedColor        [UIColor colorWithRed:204.0f/255.0f green:34.0f/255.0f blue:43.0f/255.0f alpha:1.0]
#define PView_GreenColor      [UIColor colorWithRed:36.0f/255.0f green:211.0f/255.0f blue:142.0f/255.0f alpha:1.0]//RgbColor(54.0f, 183.0f, 173.0f)
...
#define BASE_URL @"http://120.26.116.71:8016/MiddleLearnExam.asmx"  //中考外网地址


//#define HIGH_BASE_URL @"http://172.16.0.206:8055/HighLearnExam.asmx"  //高考内网地址
//#define HIGH_BASE_URL @"http://121.40.181.136:8016/HighLearnExam.asmx"  //高考外网地址
#define HIGH_BASE_URL @"http://120.26.116.71:8016/HighLearnExam.asmx"  //高考外网地址
...
#define KNOWLEDGENAME   @"KNOWLEDGENAME" //知识点名称

// 校内登录时  记住账号密码
#define INNER_MYNAME          @"INNER_MYNAME"
#define INNER_MYPHONE         @"INNER_MYPHONE"
#define INNER_MYPASSWORD      @"INNER_MYPASSWORD"

// 校外登录时  记住账号密码
#define OUT_MYNAME          @"OUT_MYNAME"
#define OUT_MYPHONE         @"OUT_MYPHONE"
#define OUT_MYPASSWORD      @"OUT_MYPASSWORD"

#define WHETHERTHECANCELLATION @"WHETHERTHECANCELLATION" //是否注销
#define ISINNER @"ISINNER" //是否是校内学生
