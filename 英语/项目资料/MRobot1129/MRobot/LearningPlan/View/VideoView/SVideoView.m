...
-(id)initWithFrame:(CGRect)frame listIndex:(NSInteger)listIndex coverImgStr:(NSString *)coverImgStr videoName:(NSString *)videoNameStr trainBtnTitle:(NSString *)btnTitle
{
    self = [super initWithFrame:frame];
    if (self) {
        UIView *contentView = [[UIView alloc] initWithFrame:CGRectMake(0, 0.5, frame.size.width, frame.size.height*SIZE_TIMES - 0.5)];
        contentView.backgroundColor = [UIColor colorWithRed:186/255.0 green:175/255.0 blue:129/255.0 alpha:1];
...
//        [skillVideoBtn setBackgroundImage:[UIImage imageNamed:@"PLAY"] forState:UIControlStateNormal];
        skillTrainBtn.backgroundColor = [UIColor clearColor];
        ...
        [videoLab setTextColor:[UIColor whiteColor]];
...
//        [skillTrainBtn setBackgroundColor:[UIColor colorWithRed:231/255.0 green:170/255.0 blue:17/255.0 alpha:1]];
        [skillTrainBtn setTitle:btnTitle forState:UIControlStateNormal];
