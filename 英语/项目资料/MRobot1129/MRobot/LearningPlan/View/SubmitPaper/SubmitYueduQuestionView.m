...
#import "DrawerView.h"
@implementation SubmitYueduQuestionView
...
//    _qTitleLabel.text = data.qTitle;
    ...
    if ([[page valueForKey:@"type"] isEqual:@"0"]) {
        if ([data.questionType isEqualToString:@"0"]) {
            _questionView1 = [[SubmitQuestionView alloc]initWithFrame:CGRectMake(0, _topBgView.bottom + 20 , self.width, MainScreenSize_H - _topBgView.bottom - 20)];
            ...
            _questionView1 = [[SubmitQuestionView alloc]initWithFrame:CGRectMake(0, 10 , self.width, MainScreenSize_H)];
            _questionView1.only = NO;
            _questionView1.delegate = self;
            _questionView1.whichMV = _whichMV;
            [_questionView1 addDanxuanData:[page valueForKey:@"title"] andAnswer:arr];
        ...
        if ([data.questionType isEqualToString:@"0"]) {
            _questionView2 = [[SubmitTianQuestionView alloc]initWithFrame:CGRectMake(0, _topBgView.bottom + 20 , self.width, MainScreenSize_H - _topBgView.bottom - 20)];
...
#pragma mark  ----SubmitTianQuestionViewDelegate----
