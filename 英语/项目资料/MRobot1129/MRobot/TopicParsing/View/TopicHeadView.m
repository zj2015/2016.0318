...
- (id)initWithReuseIdentifier:(NSString *)reuseIdentifier with:(TopicHeadViewBlock)block
{
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        _topicNameLab.font = [UIFont systemFontOfSize:16.0];
        
        [self.contentView addSubview:_topicNameLab];
        
        _signImgView = [[UIImageView alloc] initWithFrame:CGRectMake(MainScreenSize_W - 30, TopicHeadHeight/2 - 17*SIZE_TIMES/2, 17*SIZE_TIMES/2, 17*SIZE_TIMES)];
