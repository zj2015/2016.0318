...
+ (void)initialize
{
    if (self == [PICircularProgressView class])
    {
        ...
        [appearance setThicknessRatio:0.10f];
        
        [appearance setInnerBackgroundColor:nil];
        [appearance setOuterBackgroundColor:nil];
        
        [appearance setTextColor:PView_RedColor];
        [appearance setFont:[UIFont systemFontOfSize:10]];
        [appearance setProgressFillColor:nil];
        
        [appearance setProgressTopGradientColor:[UIColor brownColor]];
        [appearance setProgressBottomGradientColor:[UIColor brownColor]];
