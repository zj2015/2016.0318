...
#import "ExamAnswerView.h"

@implementation ExamAnswerView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _normalLabel1 = [[UILabel alloc]initWithFrame:CGRectMake(10, 20, MainScreenSize_W -20, 20)];
        _normalLabel1.font = [UIFont boldSystemFontOfSize:14];
        _normalLabel1.text = @"已答           未答";
        [_bgScrollView addSubview:_normalLabel1];
        
        _trueLabel = [[UILabel alloc]initWithFrame:CGRectMake(50, 20, 20, 20)];
        ...
        _noneLabel = [[UILabel alloc]initWithFrame:CGRectMake(130, 20, 20, 20)];
...
- (void)chooseWhatTitle:(UITapGestureRecognizer *)tap
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(ExamAnswerViewDelegateWithTag:)]) {
        [self.delegate ExamAnswerViewDelegateWithTag:tap.view.tag];
    }
}
