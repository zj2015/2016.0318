...
@interface SubmitWrongViewController : BaseViewController<AVAudioPlayerDelegate,UIAlertViewDelegate,SubmitTingliQuestionViewDelegate,SubmitQuestionViewDelegate,SubmitTianQuestionViewDelegate,SubmitYueduQuestionViewDelegate,UIScrollViewDelegate,QuestionAnswerDelegate>
{
    BOOL bsound;//语音是否播放
}
