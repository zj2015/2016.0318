...
- (void)viewDidLoad {
    ...
    innerBtn.frame = CGRectMake((MainScreenSize_W - 90*SIZE_TIMES*2)/3, 130*SIZE_TIMES, 90*SIZE_TIMES, 90*SIZE_TIMES);
    innerBtn.tag = 1;
    ...
    outBtn.frame = CGRectMake((MainScreenSize_W - 90*SIZE_TIMES*2)/3*2+90*SIZE_TIMES, 130*SIZE_TIMES, 90*SIZE_TIMES, 90*SIZE_TIMES);
    outBtn.tag = 2;
    ...
    UILabel *innerLab = [[UILabel alloc] initWithFrame:CGRectMake((MainScreenSize_W - 120*SIZE_TIMES*2)/3, CGRectGetMaxY(innerBtn.frame), 120*SIZE_TIMES, 20*SIZE_TIMES)];
    ...
    UILabel *outLab = [[UILabel alloc] initWithFrame:CGRectMake((MainScreenSize_W - 120*SIZE_TIMES*2)/3*2+120*SIZE_TIMES, CGRectGetMaxY(outBtn.frame), 120*SIZE_TIMES, 20*SIZE_TIMES)];
    outLab.text = @"我是校外学生";
    outLab.font = [UIFont systemFontOfSize:16];
    outLab.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:outLab];
    
    UILabel *bottomLab = [[UILabel alloc] initWithFrame:CGRectMake((MainScreenSize_W - 120*SIZE_TIMES)/2, MainScreenSize_H - 40*SIZE_TIMES, 120*SIZE_TIMES, 20*SIZE_TIMES)];
