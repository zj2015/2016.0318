...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        rowView = [[UIView alloc] initWithFrame:CGRectMake(5, 1, MainScreenSize_W-10, 47*SIZE_TIMES)];
        ...
        contentLab = [[UILabel alloc] initWithFrame:CGRectMake(20+30*SIZE_TIMES, 10*SIZE_TIMES, MainScreenSize_W - 20 - 30*SIZE_TIMES, 30*SIZE_TIMES)];
        [bgView addSubview:contentLab];
        
        rightImageView = [[UIImageView alloc]initWithFrame:CGRectMake(MainScreenSize_W - 40*SIZE_TIMES, 10*SIZE_TIMES , 30*SIZE_TIMES, 30*SIZE_TIMES)];
