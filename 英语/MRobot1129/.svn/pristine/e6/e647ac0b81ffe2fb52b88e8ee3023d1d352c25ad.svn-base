...
- (instancetype)initWithFrame:(CGRect)frame andImage:(UIImage *)image
{
    ...
    if (self) {
        ...
        [singletap requireGestureRecognizerToFail:tapGestureRecognizer];
...
{
    UITapGestureRecognizer *tapGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(ç)];
    tapGestureRecognizer.numberOfTapsRequired = 2;
    [_containerView addGestureRecognizer:tapGestureRecognizer];
}
