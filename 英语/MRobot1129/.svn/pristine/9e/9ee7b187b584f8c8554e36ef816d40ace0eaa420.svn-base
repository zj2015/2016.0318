...
@interface ExamTestViewController : BaseViewController<UIScrollViewDelegate,UIAlertViewDelegate,AVAudioPlayerDelegate,ExamAnswerViewDelegate,SimuBlanksViewDelegate,SimuHearingViewDelegate,SimuReadingViewDelegate,SimuTheRadioViewDelegate>
{
    BOOL bsound;//语音是否播放
    int myPage;
    int j ;
...
@property (strong, nonatomic) ExamAnswerView *answerView;//答案对照
@property (strong, nonatomic) NSMutableArray *answerArr;// 0 没写， 1 写了
...
@property (strong, nonatomic) NSString * submitTitle;//试卷题目
